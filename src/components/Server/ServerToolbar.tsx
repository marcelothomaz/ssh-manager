...
const ServerToolbar = ({ onServerSync }) => {
  return (
    <div className="w-full bg-indigo-600 h-20 mx-auto flex justify-center space-x-2">
      ...
      <button onClick={onServerSync} className="inline-flex items-center self-center my-auto px-4 py-2 bg-indigo-500 hover:bg-indigo-800 text-white text-sm font-medium rounded-md transition delay-50 ease-in shadow-md">
        <ArrowUpOnSquareStacked />
